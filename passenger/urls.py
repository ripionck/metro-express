...
from .views import PassengerRegistrationView, RegistrationConfirmationView, ActivateAccountView,PassengerloginView, ProfileUpdateView, PassengerLogoutView, PasswordChangeView
